...
<head>
	...
	<link rel="stylesheet" type="text/css" href="clt1.css">
	<style type="text/css">
...
<?php
       ...
       $pwd="";
       $con = mysqli_connect($url,$use,$pwd,$bd);
       $resultat =mysqli_query($con,"select *from login where type like 'client'"); 
    ...
    data-aos-duration="1000">
		<tr>
         ...
         <tr>
         	...
         	<td>
         		<a href="<?php echo "del_clt.php?id=".$row[0]."" ?>">Supprimer</a>
         	</td>   
