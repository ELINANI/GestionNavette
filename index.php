	...
	html,body
{
	...
	width: 100%;
		...
		{
		 margin-bottom: 10px;
            background: url(img/slide/111.png) 50% 50%;
...
<form action="pp.php" method="POST">
    ...
    data-aos-duration="1000">
    			<li class="login"><a href="#" data-toggle="modal">Login</a></li>
    ...
    <div class="containt" data-aos="fade-up" data-aos-delay="0"
    data-aos-duration="1000">
    	<p><span>P</span>rend en charge efficacement le service de navette pour la locations de bus</p>
       	  <span></span>
    	  <span><a href="" data-aos="fade-up" data-aos-delay="50"
    data-aos-duration="1500">Read More</a></span>
    	  <span></span>
    </div>
</header>
<br><br><br><br>
